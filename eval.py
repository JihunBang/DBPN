...
parser.add_argument('--input_dir', type=str, default='./input/2xLR')
parser.add_argument('--output', default='./dataset/output', help='Location to save checkpoint models')
...
parser.add_argument('--model', default='C:/Users/jihun/DBPN-Pytorch/models/DBPN_x2.pth', help='sr pretrained base model')
